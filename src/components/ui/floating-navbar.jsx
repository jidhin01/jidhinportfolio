      ...
      <motion.div
        ...
        {navItems.map((navItem, idx) => (
          <Link
            ...
            activeClass="active"
            className={cn(
              "relative  items-center flex space-x-1 text-neutral-500 hover:text-neutral-400  cursor-pointer"
            )}>
        ...
        to="Herosection"
          ...
          className="border text-sm font-medium relative border-white/[0.2] text-neutral-500 hover:text-neutral-400 hover:border-neutral-400 px-4 py-2 rounded-full">
          <span>JIDHIN</span>
          <span
