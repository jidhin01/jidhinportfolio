...
import { DiJavascript1, DiReact, DiHtml5, DiCss3, DiNodejs, DiPython, DiGit, DiSqllite, DiDjango } from 'react-icons/di';
...
export const Skills = () => {
  ...
  return (
    ...
    <section
      id="Skills"  
      className="h-[20rem] w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased py-50"
    >
       <BackgroundBeams />

       <div className="container mx-auto px-4 relative z-10">
         <h2 className="text-4xl font-extrabold text-center mb-12 text-neutral-500">I Know</h2>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 max-w-4xl mx-auto">
          {mySkills.map((skill, index) => (
            <div
              key={index} 
              className=" p-6 rounded-[20px] shadow-lg flex flex-col items-center justify-center
            ...
            >
              ...
              <p className="mt-4 text-lg font-semibold text-neutral-500">{skill.name}</p>
            </div>
          ))}
        </div>
      </div>
